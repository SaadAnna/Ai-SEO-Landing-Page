...
export const Testimonials = () => {
  ...
  <h2 className="text-5xl md:text-6xl text-center tracking-tighter font-medium ">Beyond Expecatations

  </h2>
  <p className="text-white/70 text-lg md:text-xl text-center mt-5 max-w-sm mx-auto">Our revolutionary AI SEO tools have transformed our clients&apos; startegies
